...
class CheckpointConfig:
    ...
    require_output_for_completed: bool = True
...
class CheckpointStore:
    ...
    def __init__(
        ...
        *,
        ...
        self.path = Path(path)
        self.resume = resume
        self.require_output_for_completed = require_output_for_completed
    ...
    def from_output_dir(
        ...
        *,
        ...
        return cls(
            ...
            require_output_for_completed=(
                checkpoint_config.require_output_for_completed
            ),
        )
    ...
    def is_completed(self, sample_id: str, record_path: str | Path) -> bool:
        ...
        if sample.get("status") != "completed":
            return False
        return not self.require_output_for_completed or Path(record_path).exists()
