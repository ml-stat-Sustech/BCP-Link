    ...
    def __init__(
        ...
        *,
        ...
        if config is not None:
            ...
            if vector_num_candidates is None:
        ...
        if vector_num_candidates is not None and vector_num_candidates <= 0:
            raise ValueError("vector_num_candidates must be positive")
        ...
        self.vector_num_candidates = vector_num_candidates
        ...
        *,
        ...
        if query_vector is not None:
            knn: dict[str, Any] = {
                ...
                "k": top_k,
                "num_candidates": self.vector_num_candidates or top_k,
            }
            body["knn"] = knn
