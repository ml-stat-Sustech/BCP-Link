            ...
            "choices": [
                {
                    ...
                    "message": {
                        ...
                        "tool_calls": tool_calls or [TOOL_CALL],
                    },
...
def _two_tool_call_response() -> httpx.Response:
    return _tool_call_response(usage=HIGH_USAGE, tool_calls=TOOL_CALLS)
...
def context(
    ...
    *,
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if outcome == "tool_call_two":
            return _two_tool_call_response()
        if outcome == "final":
